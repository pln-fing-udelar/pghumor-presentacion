...
\begin{frame}
    ...
    \begin{center}
        \begin{tabular}{c | c | c | c | c}
            & \multicolumn{2}{c |}{Altura} & \multicolumn{2}{c}{Largo del pelo} \\
            \hline
            & Alto & Bajo & Largo & Corto \\
            \hline
            Hombre & 0,80 & 0,20 & 0,25 & 0,75 \\
            \hline
            Mujer & 0,30 & 0,70 & 0,90 & 0,10 \\
        \end{tabular}

        \vfill

        Es igual de probable ser hombre o mujer.

        \vfill

        ¿Si alguien es alto y de pelo corto?

        \vfill

        \begin{align*}
            P(Altura=Alto|Hombre) \times P(Largo\ del\ pelo=Corto|Hombre) &= 0,60 \\
            P(Altura=Alto|Mujer) \times P(Largo\ del\ pelo=Corto|Mujer) &= 0,05
        \end{align*}
    \end{center}
\end{frame}
