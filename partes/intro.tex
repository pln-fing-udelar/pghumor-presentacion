...
\note{Concretando, el objetivo de este trabajo es construir un clasificador de humor en textos en idioma español, en particular en tweets, utilizando métodos de aprendizaje automático. Para esto es necesario primero construir un corpus, un conjunto de textos, de tweets en español marcados como humorísticos o como no humorísticos.}
