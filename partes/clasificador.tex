...
\begin{frame}
    ...
    \begin{itemize}
        \item ¿El clasificador acierta más a tweets con mayor promedio de estrellas?
        \item Se construye una medida de Recall ponderado y se comprueba que existe esta tendencia aunque levemente.
