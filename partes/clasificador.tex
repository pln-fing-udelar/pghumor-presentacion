...
\note{Esta es la gráfica resultado que se obtiene de la Eliminación recursiva de atributos. El máximo acierto se obtiene al eliminar tres, pero observar que la variación total del acierto es muy poca, inclusive para el máximo. Notar también que sólo con una característica, en este caso Diálogo, se obtiene muy buen acierto.
